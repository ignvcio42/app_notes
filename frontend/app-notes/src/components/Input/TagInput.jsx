        ...
        <>
            <div>
                ...
                <div className='flex items-center gap-4 mt-3'>
                    <input type="text" className='text-sm bg-transparent border px-3 py-2 rounded outline-none' placeholder='Agregar tag' onChange={handleInputChange} onKeyDown={handleKeyDown} value={inputValue} />
